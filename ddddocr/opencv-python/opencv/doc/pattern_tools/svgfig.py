...
def totrans(expr, vars=("x", "y"), globals=None, locals=None):
    ...
    globals    default=None              src of global variables
    locals     default=None              src of local variables
    """
    if locals is None:
...
def funcRtoC(expr, var="t", globals=None, locals=None):
    ...
    globals default=None    src of global variables used in the expression;
