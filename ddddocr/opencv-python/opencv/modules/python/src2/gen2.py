    ...
    def gen_code(self, codegen):
        ...
        for v in self.variants:
            ...
            if v.args and v.py_arglist:
                ...
                # form the argument parse ־Զcode that:
...
class PythonWrapperGenerator(object):
    ...
    def gen(self, srcfiles, output_path):
        ...
        # step 2: generate ־Զcode for the classes and their methods
        ...
        # step 3: generate the ־Զcode for all the global functions
        ...
        # step 4: generate the ־Զcode for enum types
        enumlist = list(self.enums.values())
        enumlist.sort()
        for name in enumlist:
            self.gen_enum_reg(name)

        # step 5: generate the ־Զcode for constants
